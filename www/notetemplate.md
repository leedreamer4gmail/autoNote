# <概括行标题>经验
- 版本：<>  //每次更新都要升级版本，三位数字，格式为：主版本号.次版本号.修订号，根据改动大小填写
- <日期xxxx,xx,xx>：<作者> - <简约描述10个字>  //作者不是写用户，而是填写写这个笔记的ai或者程序，要获取ai的名字
- ...  //每次更新都要添加一行，按照日期倒序排列，最新的在最上面
- ...
...
# Git 经验
- 版本：1.0.0
- 2024-06-01：copilot - GitHub Push Protection 阻止包含密钥的 push
- 2024-05-30：copilot - 新建本地仓库并
